...
#Open model. Had to change model name
...
def predict():
    ...
    #obtain all form values and place them in an array, convert into integers. Had to refactor the INT to Float.
    ...
    if output < 0:
        ...
        return render_template('index.html', prediction_text = 'Predicted win percentage is: {}'.format(output))   
